// $ANTLR 3.1 jkit/java/Java.g 2008-12-02 15:58:34
...
public class JavaLexer extends Lexer {
    ...
    public final void mHexLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:935:12: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // jkit/java/Java.g:935:14: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            ...
            // jkit/java/Java.g:935:28: ( HexDigit )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            ...
            // jkit/java/Java.g:935:38: ( IntegerTypeSuffix )?
            int alt2=2;
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:937:16: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // jkit/java/Java.g:937:18: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            // jkit/java/Java.g:937:18: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // jkit/java/Java.g:937:25: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // jkit/java/Java.g:937:34: ( '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
            ...
            // jkit/java/Java.g:937:45: ( IntegerTypeSuffix )?
            int alt5=2;
    ...
    public final void mOctalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:939:14: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // jkit/java/Java.g:939:16: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            // jkit/java/Java.g:939:20: ( '0' .. '7' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
            ...
            // jkit/java/Java.g:939:32: ( IntegerTypeSuffix )?
            int alt7=2;
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // jkit/java/Java.g:942:10: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // jkit/java/Java.g:942:12: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mIntegerTypeSuffix() throws RecognitionException {
        try {
            // jkit/java/Java.g:945:19: ( ( 'l' | 'L' ) )
            // jkit/java/Java.g:945:21: ( 'l' | 'L' )
            {
    ...
    public final void mFloatingPointLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:948:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ FloatTypeSuffix | ( '0' .. '9' )+ Exponent FloatTypeSuffix )
            int alt18=5;
            alt18 = dfa18.predict(input);
            switch (alt18) {
                case 1 :
                    // jkit/java/Java.g:948:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    // jkit/java/Java.g:948:9: ( '0' .. '9' )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
                    ...
                    // jkit/java/Java.g:948:37: ( Exponent )?
                    int alt10=2;
                    ...
                    // jkit/java/Java.g:948:47: ( FloatTypeSuffix )?
                    int alt11=2;
                    ...
                    break;
                case 2 :
                    // jkit/java/Java.g:949:9: '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )?
                    {
                    match('.'); 
                    // jkit/java/Java.g:949:13: ( '0' .. '9' )+
                    int cnt12=0;
                    loop12:
                    do {
                        int alt12=2;
                    ...
                    // jkit/java/Java.g:949:25: ( Exponent )?
                    int alt13=2;
                    ...
                    // jkit/java/Java.g:949:35: ( FloatTypeSuffix )?
                    int alt14=2;
                    ...
                    break;
                case 3 :
                    // jkit/java/Java.g:950:9: ( '0' .. '9' )+ Exponent
                    {
                    // jkit/java/Java.g:950:9: ( '0' .. '9' )+
                    int cnt15=0;
                    loop15:
                    do {
                        int alt15=2;
                    ...
                    break;
                case 4 :
                    // jkit/java/Java.g:951:7: ( '0' .. '9' )+ FloatTypeSuffix
                    {
                    // jkit/java/Java.g:951:7: ( '0' .. '9' )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
                    ...
                    break;
                case 5 :
                    // jkit/java/Java.g:952:9: ( '0' .. '9' )+ Exponent FloatTypeSuffix
                    {
    ...
    public final void mExponent() throws RecognitionException {
        try {
            // jkit/java/Java.g:956:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // jkit/java/Java.g:956:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public final void mFloatTypeSuffix() throws RecognitionException {
        try {
            // jkit/java/Java.g:959:17: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // jkit/java/Java.g:959:19: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    public final void mCharacterLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:962:5: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // jkit/java/Java.g:962:9: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 
            // jkit/java/Java.g:962:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // jkit/java/Java.g:962:16: EscapeSequence
                    {
                    mEscapeSequence(); 
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            // jkit/java/Java.g:966:8: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // jkit/java/Java.g:966:12: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            loop22:
            do {
                int alt22=3;
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // jkit/java/Java.g:971:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
            int alt23=3;
            ...
            switch (alt23) {
                case 1 :
                    // jkit/java/Java.g:971:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    {
                    match('\\'); 
                    ...
                    break;
                case 2 :
                    // jkit/java/Java.g:972:9: UnicodeEscape
                    {
                    mUnicodeEscape(); 
                    ...
                    break;
                case 3 :
                    // jkit/java/Java.g:973:9: OctalEscape
                    {
                    mOctalEscape(); 
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // jkit/java/Java.g:978:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt24=3;
            ...
            switch (alt24) {
                case 1 :
                    // jkit/java/Java.g:978:9: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    {
                    match('\\'); 
                    // jkit/java/Java.g:978:14: ( '0' .. '3' )
                    // jkit/java/Java.g:978:15: '0' .. '3'
                    {
                    matchRange('0','3'); 

                    }

                    // jkit/java/Java.g:978:25: ( '0' .. '7' )
                    // jkit/java/Java.g:978:26: '0' .. '7'
                    {
                    matchRange('0','7'); 

                    }

                    // jkit/java/Java.g:978:36: ( '0' .. '7' )
                    // jkit/java/Java.g:978:37: '0' .. '7'
                    {
                    matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // jkit/java/Java.g:979:9: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    {
                    match('\\'); 
                    // jkit/java/Java.g:979:14: ( '0' .. '7' )
                    // jkit/java/Java.g:979:15: '0' .. '7'
                    {
                    matchRange('0','7'); 
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // jkit/java/Java.g:985:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // jkit/java/Java.g:985:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
            match('u'); 
            mHexDigit(); 
    ...
    public final void mENUM() throws RecognitionException {
        try {
            int _type = ENUM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:988:5: ( 'enum' )
            // jkit/java/Java.g:988:7: 'enum'
            {
            match("enum"); 
    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:992:5: ( Letter ( Letter | JavaIDDigit )* )
            // jkit/java/Java.g:992:9: Letter ( Letter | JavaIDDigit )*
            {
            mLetter(); 
            // jkit/java/Java.g:992:16: ( Letter | JavaIDDigit )*
            loop25:
            do {
                int alt25=2;
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // jkit/java/Java.g:1000:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // jkit/java/Java.g:
            {
    ...
    public final void mJavaIDDigit() throws RecognitionException {
        try {
            // jkit/java/Java.g:1017:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
            // jkit/java/Java.g:
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:1034:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
            // jkit/java/Java.g:1034:8: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:1038:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // jkit/java/Java.g:1038:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // jkit/java/Java.g:1038:14: ( options {greedy=false; } : . )*
            loop26:
            do {
                int alt26=2;
    ...
    public final void mLINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // jkit/java/Java.g:1042:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
            // jkit/java/Java.g:1042:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
            {
            match("//"); 

            // jkit/java/Java.g:1042:12: (~ ( '\\n' | '\\r' ) )*
            loop27:
            do {
                int alt27=2;
    ...
    class DFA18 extends DFA {
        ...
        public String getDescription() {
            return "947:1: FloatingPointLiteral : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ FloatTypeSuffix | ( '0' .. '9' )+ Exponent FloatTypeSuffix );";
        }
    }
