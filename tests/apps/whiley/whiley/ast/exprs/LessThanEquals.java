 ...
 */
public class LessThanEquals extends SyntacticElementImpl implements Condition, BinOp {
    private final Expression lhs;
    private final Expression rhs;
    
    public LessThanEquals(Expression lhs, Expression rhs, Attribute... attributes) {
    	super(attributes);
		this.lhs = lhs;
		this.rhs = rhs; 
    }
